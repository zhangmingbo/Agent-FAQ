...
export function createRouter() {
  ...
  router.post('/tasks', asyncHandler(async (req, res) => {
    const { code, name, description, trigger_keywords, slots, steps, intent_examples, clarify_question, clarify_options, arb_gap, arb_task_min, arb_faq_min, completion_message, on_complete, status } = req.body
    ...
    await taskEngine.save({
      ...
      arb_gap, arb_task_min, arb_faq_min,
